...
def main():
    ...
    if results:
        ...
        print(f"  • Diferencia: {results.monthly_payment_without_bonus - results.monthly_payment_with_bonus:,.2f} € menos/mes")
        print()
        print("Totales:")
        print(f"  • Sin bonificaciones: {results.total_paid_without_bonus:,.2f} €")
        print(f"  • Con bonificaciones: {results.total_paid_with_bonus + results.total_bonus_costs:,.2f} €")
